...
flags.DEFINE_integer("test_epoch", 200, "Epoch for latent mapping in anomaly detection to train [200]")
...
flags.DEFINE_string("test_dir", "test_data", "Directory name to save the anomaly detstion result [test_data]")
...
def main(_):
  ...
  with tf.Session(config=run_config) as sess:
    ...
    if FLAGS.anomaly_test:
      ...
      for inx in range(len(dcgan.test_data_names):
        dcgan.train_anomaly_detector(FLAGS, dcgan.test_data[i], dcgan.test_data_names[i])
